...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.alp-litecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.alp-litecointools.com");
        vSeeds.emplace_back("dnsseed.alp-litecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.alp-litecointools.com");
        vSeeds.emplace_back("seed-b.alp-litecoin.loshan.co.uk");
