...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " alp-litecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  alp-litecoin-tx [options] <hex-tx> [commands]  Update hex-encoded alp-litecoin transaction\n" +
            "or:     alp-litecoin-tx [options] -create [commands]   Create hex-encoded alp-litecoin transaction\n" +
            "\n";
